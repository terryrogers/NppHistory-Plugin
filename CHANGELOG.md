...
- Added targeted recovery for a native toolbar clipped below its button height, preserving native buttons and other rebar bands. New four-pixel fault-injection regression fails on the installed baseline and passes on the correction. Core/native suite: 1,203 checks; isolated recovery/layout suites: 104 and 103 checks. Originating event and installed-environment UAT remain open; see TOOLBAR_HEIGHT_REGRESSION-2026-09-03.md.
